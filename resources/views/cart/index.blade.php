    ...
    <div class="pb-5">
      <div class="container">
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <form action="{{route('carte.destroy',$product->rowId)}}" method="POST">
                    @csrf
                    @method('delete')
        ...
        <div class="row py-5 p-4 bg-white rounded shadow-sm">
          ...
          <div class="col-lg-6">
            <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Detaiils de commande  </div>
            <div class="p-4">
         ...
         <!--        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Shipping and handling</strong><strong>$10.00</strong></li>-->
              ...
              </ul><a href="{{route('payment.index')}}" class="btn btn-dark rounded-pill py-2 btn-block">Procéder une paiement</a>
            </div>
          </div>
        </div>
