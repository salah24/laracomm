...
@section('css-index')
  ...
  <title>Boutique|Solution Digital </title>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="{{asset('imageslogo.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-3">
                                <div class="logo">
                                  <a href="index.html"><img width="150px" src="{{asset('images/logo.png')}}" alt=""></a>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-5 col-lg-3 col-md-3 col-sm-3 fix-card">
                                <ul class="header-right f-right d-none d-lg-block d-flex justify-content-between">
                                   ...
                                   <li class="d-none d-lg-block">@if (Route::has('login'))
                                    @auth
                                        <a class="btn btn-outline-info pull-right ml-2" href="{{ url('/home') }}">Home</a>
                                    @else
                                        <a class="btn btn-outline-info pull-right ml-2" href="{{ route('login') }}">Login</a>
                              
                                        @if (Route::has('register'))
                                            <a class="btn btn-outline-info pull-right" href="{{ route('register') }}">Register</a>
                                        @endif
                                    @endauth
                              @endif</li>
                                </ul>
            ...
            <div class="container">
                <div class="row product-btn d-flex justify-content-end align-items-end">
                    ...
                    <div class=" col-lg-12  mt-3">
                        <div class="section-tittle mb-3 mt-3">
                            <h2 class="mx-auto">Les Produits</h2>
                        </div>
                    </div>
                    <div class="col-lg-12 ">
                            ...
                            <nav>                                                                                                
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    @foreach ($categories as $category)
                                      <a class="nav-item nav-link" id="{{$category->id}}" data-toggle="tab" href="#{{$category->id}}" role="tab" aria-controls="{{$category->id}}" aria-selected="false">{{$category->name}}</a>
                                      @endforeach
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img width="180px" height="300px" src="{{asset('storage/'. $product->image)}}" alt="">
              ...
              <a href="{{route('product.show',$product->slug)}}" class="btn btn-primary">Consulter le produit</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                      ...
                      <div class="single-footer-caption mb-50">
                        <div class="single-footer-caption mb-30">
                            ...
                            <div class="footer-logo">
                                <a href="/"><img src="{{asset('imageslogo.png')}}" alt=""></a>
                            </div>
